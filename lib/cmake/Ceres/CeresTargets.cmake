...
set_target_properties(Ceres::ceres PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "glog::glog;gflags;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:SuiteSparse::CHOLMOD>;\$<LINK_ONLY:SuiteSparse::SPQR>;\$<LINK_ONLY:CUDA::cublas>;\$<LINK_ONLY:CUDA::cudart>;\$<LINK_ONLY:CUDA::cusolver>;\$<LINK_ONLY:CUDA::cusparse>;\$<LINK_ONLY:Ceres::ceres_cuda_kernels>;C:/Github/GISBasic3rdParty/lib/openblas.lib;Eigen3::Eigen"
)
